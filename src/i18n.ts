...
const M: Msgs = {
  ...
  'cli.invalidAgent':    ['--agent must be openclaw | claude | gemini, got: {val}', '--agent 必须是 openclaw | claude | gemini，收到: {val}'],
  ...
  'cli.cmd.agent':       ['Filter by agent (openclaw|claude|gemini)', '只操作指定智能体 (openclaw|claude|gemini)'],
